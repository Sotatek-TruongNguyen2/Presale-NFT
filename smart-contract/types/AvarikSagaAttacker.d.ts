...
interface AvarikSagaAttackerInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: "victim", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "victim", data: BytesLike): Result;
...
export class AvarikSagaAttacker extends Contract {
  ...
  interface: AvarikSagaAttackerInterface;
  ...
  functions: {
    ...
    victim(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    victim(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    victim(overrides?: CallOverrides): Promise<PopulatedTransaction>;
