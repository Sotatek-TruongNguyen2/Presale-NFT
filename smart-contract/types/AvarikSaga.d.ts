...
interface AvarikSagaInterface extends ethers.utils.Interface {
  functions: {
    "AVARIK_GIFT()": FunctionFragment;
    "AVARIK_MAX()": FunctionFragment;
    "AVARIK_PER_MINT()": FunctionFragment;
    "AVARIK_PRICE()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "AVARIK_GIFT",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "AVARIK_MAX",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "AVARIK_PER_MINT",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "AVARIK_PRICE",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "AVARIK_PRIVATE",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "AVARIK_PUBLIC",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "AVARIK_MAX", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "AVARIK_PER_MINT",
    data: BytesLike
  ): Result;
...
export class AvarikSaga extends Contract {
  ...
  interface: AvarikSagaInterface;

  functions: {
    AVARIK_GIFT(overrides?: CallOverrides): Promise<[BigNumber]>;

    "AVARIK_GIFT()"(overrides?: CallOverrides): Promise<[BigNumber]>;

    AVARIK_MAX(overrides?: CallOverrides): Promise<[BigNumber]>;

    "AVARIK_MAX()"(overrides?: CallOverrides): Promise<[BigNumber]>;

    AVARIK_PER_MINT(overrides?: CallOverrides): Promise<[BigNumber]>;

    "AVARIK_PER_MINT()"(overrides?: CallOverrides): Promise<[BigNumber]>;

    AVARIK_PRICE(overrides?: CallOverrides): Promise<[BigNumber]>;

    "AVARIK_PRICE()"(overrides?: CallOverrides): Promise<[BigNumber]>;

    AVARIK_PRIVATE(overrides?: CallOverrides): Promise<[BigNumber]>;

    "AVARIK_PRIVATE()"(overrides?: CallOverrides): Promise<[BigNumber]>;

    AVARIK_PUBLIC(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    AVARIK_GIFT(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    "AVARIK_GIFT()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    AVARIK_MAX(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    "AVARIK_MAX()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    AVARIK_PER_MINT(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    "AVARIK_PER_MINT()"(
      overrides?: CallOverrides
    ): Promise<PopulatedTransaction>;

    AVARIK_PRICE(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    "AVARIK_PRICE()"(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    AVARIK_PRIVATE(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    "AVARIK_PRIVATE()"(
      overrides?: CallOverrides
    ): Promise<PopulatedTransaction>;

    AVARIK_PUBLIC(overrides?: CallOverrides): Promise<PopulatedTransaction>;
